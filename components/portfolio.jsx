...
const Portfolio = ({ projects, frontend, mern, full }) => {
  ...
  return (
    ...
    >
      <h2 className="text-5xl title lg:text-8xl font-bold uppercase bg-gradient-to-bl dark:from-fuchsia-800 dark:to-rose-800 from-fuchsia-500 to-rose-500 bg-clip-text text-transparent py-10">
        Selected Works.
      </h2>
