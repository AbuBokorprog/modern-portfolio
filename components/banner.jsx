  ...
  return (
    <Element>
      <BackgroundBeamsWithCollision>
        ...
        >
          <div>
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-extrabold text-center bg-gradient-to-bl from-fuchsia-600 to-rose-600 dark:from-fuchsia-500 dark:to-rose-500 bg-clip-text text-transparent">
